...
<body class="bg-first">
  ...
  <section id="offers mt-5">
    <div class="container mt-5" style="border-top: 1px solid #444941;">
      <div class="row">
        <!--Grid column-->
        ...
        <div class="col-md-8 mb-md-0 mb-5">
          <table class="table">
            <div class="swiper mt-4">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide satu">
                  <img style="height: 30%; width:100%;" src="<?= base_url() ?>/img/listing/<?= $row->foto ?>" alt="">
                  <div class="caption">
                    <div class="container">
                    </div>
                  </div>
            ...
            <h4 class="mt-3 fourth"><?= $row->judul ?></h4>
            <p class="fourth"><?= $row->teks ?></p>
            <table class="table">
              <thead>
                <th>
                  <a href="<?= site_url('') ?>" class="btn btn-sm btn-danger">
                    kembali
                  </a>
                </th>
                <th></th>
                <th></th>
                <th><small class="ml-5">Blog / <?= $row->admin ?> / <?= $row->tanggal ?></small></th>
              </thead>
            </table>
        </div>
        <!--Grid column-->
