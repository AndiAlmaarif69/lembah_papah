...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url() ?>travel-ku/assets/css/style.css">
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.2.1/css/bootstrap.min.css" integrity="sha384-GJzZqFGwb1QTTN6wy59ffF1BuGJpLSa9DkKMp0DgiMDm4iYMj70gZWKYbI706tWS" crossorigin="anonymous">
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="36x26" href="<?= base_url() ?>travel-ku/assets/images/lembah-papah(1).png">
  <!-- bootstrap icon -->
...
<body class="bg-first">
  ...
  <header>
    ...
    <nav style="z-index: 9999;" class="navbar navbar-expand-lg navbar-light sticky-top">
      ...
      <a class="navbar-brand ml-5" href="<?= site_url() ?>">
        ...
        <b class="logo-icon">
          <!-- Dark Logo icon -->
          <img src="<?= base_url() ?>travel-ku/assets/images/lembah-papah(1).png" alt="homepage" width="70" height="54">
        </b>
      </a>
  ...
  background-image: url('<?= base_url() ?>/img/backrgound_aneka.png');
  height: 250px;
  ">
    <div class="mask">
      <div class="d-flex justify-content-center align-items-center h-100">
        <div class="text-white mt-5">
          <h4 class="mb-3"></h4>
          <h1 class="mb-3">Type of Tour</h1>
          <a class="third" href="<?= site_url() ?>" role="button">Home .</a>
          <a class="third" href="#!" role="button"> Aneka</a>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container mt-5">
      <div class="row">
        ...
        <div class="col-md-9 mb-md-0 mb-5">
          <div class="swiper">
            ...
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide satu">
                <img style="height: 30%; width:100%;" src="<?= base_url() ?>/img/fitur/<?= $row->foto ?>" alt="">
                <div class="caption">
                  <div class="container">
                  </div>
                </div>
          ...
          <h4 class="mt-3"><?= $row->rating ?></h4>
          <p><?= $row->button ?></p>
          <a href="<?= site_url() ?>" class="mt-2 btn btn-danger btn-sm">kembali</a>
        </div>
        <!--Grid column-->
        ...
        <div class="col-md-3 text-center">
          <div class="card">
            <h5 class="card-header">Pesan Sekarang</h5>
            <div class="card-body">
              <p class="card-text">Ada penawaran menarik setiap harinya, hanya <span class="text-danger">Rp. <?= $row->title ?></span></p>
              <a href="<?= site_url() ?>" class="btn bg-second text-light">order now</a>
            </div>
          </div>
        </div>
        <!--Grid column-->
  ...
  <footer class="text-center text-lg-start bg-first text-muted">
    ...
    <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
      ...
      <div>
        ...
        <a target="blank" href="" class="me-4 fourth">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
            ...
            <a class="navbar-brand" href="<?= site_url() ?>">
              ...
              <b class="logo-icon">
                <!-- Dark Logo icon -->
                <img src="<?= base_url() ?>travel-ku/assets/images/lembah-papah(1).png" alt="homepage" width="90" height="74">
              </b>
            </a>
          </div>
          <!-- Grid column -->
